...
Located in `/specs/architecture/docs/`:
- `01-system-architecture.md` - System design and patterns
- `02-database-design.md` - Complete database schema
- `03-api-specification.md` - All REST API endpoints
- `04-security-architecture.md` - Security implementation
- `05-backend-implementation-guide.md` - Package structure and patterns

### Task Plans
Located in `/specs/planning/`:
- `BACKEND_TASKS.md` - Your detailed task list
- `PROJECT_PLAN.md` - Overall project timeline
- `SPRINT_PLANS/` - Sprint-specific plans
