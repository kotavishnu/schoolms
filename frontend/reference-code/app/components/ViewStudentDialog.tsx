    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            View complete information for {student.firstName} {student.lastName}.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="mt-1">{new Date(student.dateOfBirth).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
                </div>
                <div>
                  <label className="text-sm text-gray-600">Age</label>
                  <p className="mt-1">{calculateAge(student.dateOfBirth)} years</p>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm text-gray-600">Adhaar Number</label>
                  <p className="mt-1">{student.adhaarNumber}</p>
                </div>
                <div>
