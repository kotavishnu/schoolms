        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {student
              ...
              : 'Enter student information to register a new student in the system. All fields marked with * are required.'}
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  {errors.dateOfBirth && <span className="text-xs text-red-600">{errors.dateOfBirth.message}</span>}
                </div>
