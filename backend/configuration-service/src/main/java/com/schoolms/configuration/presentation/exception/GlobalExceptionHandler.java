package com.schoolms.configuration.presentation.exception;
...
/**
 * Global Exception Handler (BE-037)
 * Exception handling for Configuration API
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleNotFound(ConfigurationNotFoundException ex) {
    ...
    @ExceptionHandler(DuplicateConfigKeyException.class)
    public ResponseEntity<ProblemDetail> handleDuplicate(DuplicateConfigKeyException ex) {
        ProblemDetail problem = createProblemDetail(
            HttpStatus.CONFLICT,
            "duplicate-resource",
            "Duplicate Resource",
